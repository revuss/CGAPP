...
import { useDeleteCareers } from "@/app/services/adminServices/adminHooks";
import { Trash2 } from "lucide-react";

const CareersDelete = ({ closeMe, userId, refetch }: any) => {
  ...
  const { mutate } = useDeleteCareers(fetchDataOptions);

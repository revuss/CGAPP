import { useDeleteProduct } from "@/app/services/adminServices/adminHooks";
import { Trash2 } from "lucide-react";

/* eslint-disable @typescript-eslint/no-explicit-any */
const ProductDelete = ({ closeMe, userId, refetch }: any) => {
  ...
  const { mutate } = useDeleteProduct(fetchDataOptions);

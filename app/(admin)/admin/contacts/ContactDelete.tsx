import { useDeleteContacts } from "@/app/services/adminServices/adminHooks";
import { Trash2 } from "lucide-react";
import React from "react";

// eslint-disable-next-line @typescript-eslint/no-explicit-any
const ContactDelete = ({ closeMe, userId }: any) => {
  ...
  const { mutate } = useDeleteContacts(fetchDataOptions);
